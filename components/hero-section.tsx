...
export function HeroSection() {
  return (
    <section className="relative h-screen min-h-[600px] flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 bg-primary" aria-label="Hero image placeholder">
        <div className="absolute inset-0 bg-primary/60" />
      </div>

      {/* Content */}
      <div className="relative z-10 text-center px-6">
        <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl font-medium text-primary-foreground tracking-wider leading-tight text-balance">
          {"ともにまなび ともに生きる"}
        </h1>
      ...
      <div className="absolute bottom-0 left-0 right-0 bg-card/95 backdrop-blur-sm border-t border-border">
        <div className="mx-auto max-w-7xl px-6 py-3 flex items-center gap-4">
          <div className="flex items-center gap-2 text-muted-foreground shrink-0">
            ...
            <span className="text-xs font-light">2025.11.04</span>
          </div>
