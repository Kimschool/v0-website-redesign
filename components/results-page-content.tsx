...
const alumniData = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "陳　子栄　中国出身　2025年EJU日本語最高点。進学先：東京大学 理科二類。",
      "2023年の夏休みにKCPを見学したことをきっかけに、日本に留学して勉強したいと思うようになりました。そして2024年4月にKCPに入学しました。",
      "KCPでの2年間の勉強を経て、東京大学理科二類、東京科学大学材料系、東京理科大学電気電子情報工学科に合格することができました。",
      "KCPでは、日本語の基礎をとてもしっかりと身につけることができました。授業では日本語だけでなく、日本の文化や生活習慣についても学ぶことができ、日本で生活するうえで大変役立つ内容でした。日本社会への理解が深まり、日本人の考え方や習慣についても知ることができたと思います。さらに、KCPにはEJUコースや進学対策の授業があり、受験に関する有益な情報をたくさん得ることができました。どの時期に何をするべきかなど、受験準備の進め方を学ぶことができ、とても参考になりました。受験勉強の過程は決して簡単なものではありませんでした。私にとって一番難しかったのは、失敗とどう向き合うかということでした。失敗を受け入れ、原因を分析し、その経験を次に生かすことが大切だと思います。以前の私は失敗から目を背けてしまうこともありましたが、それでは前に進めないと気づきました。そのような悩みを抱えていたとき、KCPの先生方が大きな支えになってくれました。進学のアドバイスだけでなく、個人的な相談にも親身に乗ってくださり、とても心強く、温かい気持ちになりました。KCPでの生活には楽しいこともあれば、大変なこともありました。課外活動では葛西臨海公園でのBBQや、川越・箱根・江の島への旅行など、楽しい思い出がたくさんあります。一方で、授業では宿題やテストも多く大変なこともありました。しかし、こうした学習を通して日本語の知識がしっかりと身についたと感じています。特に印象に残っているのは、KCPで学んだ文法と読解の授業です。受験の際にも多く役立ちました。上級クラスで使用した『ちくま評論選』という教材では、社会や哲学に関するさまざまなテーマを読むことができ、とても興味深かったです。これからKCPで進学を目指す後輩の皆さんには、ぜひ毎日の授業を大切にしてほしいと思います。しっかり授業に参加すれば、きっと多くの学びと成長を得ることができるはずです。皆さんが日本で充実した留学生活を送れることを心から願っています。",
    ],
    previewCount: 2,
  },
  {
    ...
    paragraphs: [
      "2023年の夏休みにKCPを見学したことをきっかけに、日本に留学して勉強したいと思うようになりました。そして2024年4月にKCPに入学しました。",
      "KCPでの2年間の勉強を経て、東京大学理科二類、東京科学大学材料系、東京理科大学電気電子情報工学科に合格することができました。",
      "KCPでは、日本語の基礎をとてもしっかりと身につけることができました。授業では日本語だけでなく、日本の文化や生活習慣についても学ぶことができ、日本で生活するうえで大変役立つ内容でした。日本社会への理解が深まり、日本人の考え方や習慣についても知ることができたと思います。KCPにはEJUコースや進学対策の授業があり、受験に関する有益な情報をたくさん得ることができました。どの時期に何をするべきかなど、受験準備の進め方を学ぶことができ、とても参考になりました。",
      "受験勉強の過程は決して簡単なものではありませんでした。私にとって一番難しかったのは、失敗とどう向き合うかということでした。失敗を受け入れ、原因を分析し、その経験を次に生かすことが大切だと思います。以前の私は失敗から目を背けてしまうこともありましたが、それでは前に進めないと気づきました。",
      "そのような悩みを抱えていたとき、KCPの先生方が大きな支えになってくれました。進学のアドバイスだけでなく、個人的な相談にも親身に乗ってくださり、とても心強く、温かい気持ちになりました。",
      "KCPでの生活には楽しいこともあれば、大変なこともありました。課外活動では葛西臨海公園でのBBQや、川越・箱根・江の島への旅行など、楽しい思い出がたくさんあります。一方で、授業では宿題やテストも多く大変なこともありました。しかし、こうした学習を通して日本語の知識がしっかりと身についたと感じています。",
      "特に印象に残っているのは、KCPで学んだ文法と読解の授業です。受験の際にも多く役立ちました。上級クラスで使用した『ちくま評論選』という教材では、社会や哲学に関するさまざまなテーマを読むことができ、とても興味深かったです。",
      "これからKCPで進学を目指す後輩の皆さんには、ぜひ毎日の授業を大切にしてほしいと思います。しっかり授業に参加すれば、きっと多くの学びと成長を得ることができるはずです。皆さんが日本で充実した留学生活を送れることを心から願っています。",
    ],
    previewCount: 2,
  },
  {
    ...
    <div className="border border-gray-300 rounded-lg overflow-hidden">
      <div className="grid md:grid-cols-3 gap-0">
        ...
        <div className="md:col-span-2 p-8 bg-white">
          ...
          {"highlightLines" in alumni && alumni.highlightLines && (
            <div className="mt-3 space-y-0.5">
              {alumni.highlightLines.map((line: string, i: number) => (
                <p key={i} className="text-gray-600 text-xs font-semibold">
                  {line}
                </p>
              ))}
            </div>
