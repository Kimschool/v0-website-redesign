                ...
                <div className="grid md:grid-cols-3 gap-0">
                  ...
                  <div className="md:col-span-2 p-8 bg-white">
                    ...
                    <div className="space-y-4 text-gray-700 leading-relaxed text-sm">
                      ...
                      <p>また、勉強だけでなく、KCPの課外活動にも積極的に参加しました。演劇部の一員として、教科書だけでは学べない日本語表現を数多く身につけることができ、同じ��を持つ仲間とも出会うことができました。卒業後も、私たちは今なお連絡を取り合っています。</p>
                      <p>こうした経験から、留学生活ではぜひ異なる文化的背景を持つ仲間と積極的に交流することをおすすめします。視野が広がるだけでなく、物事をさまざまな立場や視点から考えられるようにな���、何よりもかけがえのない友情を得ることができます。</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="grid md:grid-cols-3 gap-0">
                  ...
                  <div className="md:col-span-2 p-8 bg-white">
                    ...
                    <div className="space-y-4 text-gray-700 leading-relaxed text-sm">
                      ...
                      <p>私がKCPに通っていた時期はコロナ禍だったため、みんなで参加できるイベントがあまり多くありませんでした。その中でも特に印象に残っているのがスピーチ大会です。私は���ラスメートと一緒に応援動画を作成し、クラスメート���員の似顔絵を描きました。</p>
                ...
                <div className="grid md:grid-cols-3 gap-0">
                  ...
                  <div className="md:col-span-2 p-8 bg-white">
                    ...
                    <div className="space-y-4 text-gray-700 leading-relaxed text-sm">
                      ...
                      <p>最初は簡単な文から始まり、徐々��複雑な文型を使えるようになったことが、自信にもつながりました。KCPの授業の良いところは、中級という基礎を築く段階で繰り返し練習を行い、記憶を定着させていくことに重点が置かれている点です。語彙や文法の説明も丁寧で、意味や使い方の広がりについても詳しく教えてくださるので、その後の高度な日本語の学習やN1対策にも非常に役立ちました。</p>
