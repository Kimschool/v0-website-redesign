                ...
                <div className="grid md:grid-cols-3 gap-0">
                  ...
                  <div className="md:col-span-2 p-8 bg-white">
                    ...
                    <div className="space-y-4 text-gray-700 leading-relaxed text-sm">
                      ...
                      <p>こうした経験から、留学生活ではぜひ異なる文化的背景を持つ仲間と積極的に交流することをおすすめします。視野が広がるだけでなく、物事をさまざまな立場や視点から考えられる���う���な���、何よりもかけがえのない友情を得ることができます。</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="grid md:grid-cols-3 gap-0">
                  ...
                  <div className="md:col-span-2 p-8 bg-white">
                    ...
                    <div className="space-y-4 text-gray-700 leading-relaxed text-sm">
                      ...
                      <p>私がKCPに通っていた時期はコロナ禍だったため、みんなで参加できるイベントがあまり多くありませんでした。その中でも特に印象に残っているのがスピー���大会で���。私は���ラスメートと一緒に応援動画を作成し、クラスメート���員の似顔絵を描きました。</p>
